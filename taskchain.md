...
- **Next objective:** Validate the component-family and portfolio-overlap inventory, complete the exact file-level path-and-hash manifest, then obtain an Architect decision for dedicated migration, modular consolidation, evidence-preserving retirement, or continued hold before additional capability, packaging, publication, or deployment work proceeds.
- **User outcome:** A defensive researcher can understand one clearly labeled prototype, reproduce documentation and local checks, distinguish implementation, configured automation, exact-generation validation, proposals, missing evidence, blocked authority, and identify how every component overlaps existing portfolio ownership.
- **MVP scope:** preserve the current prototype and history; maintain an accessible front door, architecture, onboarding, developer guide, threat model, component and overlap inventory, exit playbook, evidence classification, punch list, release gates, and changelog; inventory implemented collectors, firmware/hash checks, kernel and management-channel heuristics, PCAP analysis, dashboard/API, extension interface, dry-run isolation abstraction, image/packaging scripts, tests, CI, documentation, and compliance mappings; compare ownership with existing portfolio repositories; complete an exact path/hash manifest; select a destination, consolidation owner, retirement route, or continued hold; document source-to-target history, data, firmware, credential, network, privilege, hardware, evidence, false-positive, publication, correction, revocation, migration, retirement, and rollback boundaries; establish representative validation and adversarial fixtures; and prohibit release or deployment until evidence and approvals are complete.
...
| Local P0.1 | Maintain the incubation documentation front door | Builder | P0.0 | REVIEW | README, MkDocs routes, architecture, onboarding, developer guide, component inventory, exit playbook, punch list, task chain, release plan, and changelog agree and pass exact-head validation. |
...
| Local P0.2A | Complete exact file-level evidence and disposition manifest | Builder + Reviewer | P0.2 | IN PROGRESS | Every relevant path has a source commit, blob or content digest, component ID, evidence and sensitivity class, proposed disposition, target/archive path, owner or vacancy, known losses, correction route, and rollback treatment. |
| Local P0.3 | Complete a decision-ready incubation exit packet | Builder + Reviewer | P0.1-P0.2A | REVIEW | Four controlled dispositions, component ledger, source-to-target manifest, history preservation, contract-gluing review, hostile fixtures, rollback, restoration, and authority denials are documented without selecting a disposition. |
